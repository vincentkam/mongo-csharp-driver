...
namespace MongoDB.Driver.Core.Operations
{
    ...
    public abstract class RetryableReadCommandOperationBase : IReadOperation<BsonDocument>, IRetryableReadOperation<BsonDocument>
    {
        ...
        private CommandArgs GetCommandArgs(RetryableReadContext context, int attempt, long? transactionNumber)
        {
            ...
            args.PostReadAction = GetPostReadAction(args.CommandPayloads);
            args.ResponseHandling = GetResponseHandling();
            args.MessageEncoderSettings = CreateMessageEncoderSettings(context.Channel);
            return args;
        }

        private Action<IMessageEncoderPostProcessor> GetPostReadAction(List<Type1CommandMessageSection> commandPayloads)
        {
            return null;
        }
        ...
        private class CommandArgs
        {
            ...
            public Action<IMessageEncoderPostProcessor> PostReadAction { get; set; }
